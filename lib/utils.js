...
module.exports.getCryptoSuite = function() {
	...
	var csEnv = this.getConfigSetting('crypto-suite','./impl/CryptoSuite_ECDSA_SHA.js');
...
module.exports.newKeyValueStore = function(options) {
	// expecting a path to an alternative implementation
	var kvsEnv = this.getConfigSetting('key-value-store','./impl/FileKeyValueStore.js');
...
module.exports.getMemberService = function() {
	// expecting a path to an alternative implementation
	var msEnv = this.getConfigSetting('member-service','./impl/MemberServices.js');
...
module.exports.getLogger = function(name) {
	...
	if (config_log_setting) {
		try {
			var config = JSON.parse(config_log_setting);
