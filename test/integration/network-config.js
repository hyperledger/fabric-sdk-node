...
test('\n\n***** use the connection profile file  *****\n\n', async (t) => {
	...
	//  organization.
	const client_org1 = Client.loadFromConfig('test/fixtures/network2.yaml');
	const client_org2 = Client.loadFromConfig('test/fixtures/network2.yaml');
	...
	try {
		...
		const envelope_bytes = fs.readFileSync(path.join(__dirname, '../fixtures/crypto-material/channel-config/mychannel2.tx'));
		...
		if (result.status && result.status === 'SUCCESS') {
			...
			t.fail('Failed to create the channel named ' + channel_name);
			throw new Error('Failed to create the channel ' + channel_name);
		}
