...
test('\n\n***** U P G R A D E flow: chaincode install *****\n\n', (t) => {
	...
	e2eUtils.installChaincode('org1', testUtil.CHAINCODE_PATH, 'v1', t, true)
	.then(() => {
		t.pass('Successfully installed chaincode in peers of organization "org1"');
		return e2eUtils.installChaincode('org2', testUtil.CHAINCODE_PATH, 'v1', t, true);
	}, (err) => {
...
test('\n\n***** U P G R A D E flow: upgrade chaincode *****\n\n', (t) => {
	e2eUtils.instantiateChaincode('org1', testUtil.CHAINCODE_PATH, 'v1', true, t)
	.then((result) => {
		if(result){
