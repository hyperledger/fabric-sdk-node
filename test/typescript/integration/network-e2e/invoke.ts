...
test('\n\n***** Network End-to-end flow: specify not enough endorsing orgs using discovery *****\n\n', async (t: any) => {
	const gateway = new Gateway();
	try {
		const contract = await createContract(t, gateway, {
			clientTlsIdentity: 'tlsId',
...
test('\n\n***** Network End-to-end flow: specify correct endorsing orgs using discovery *****\n\n', async (t: any) => {
	const gateway = new Gateway();
	try {
		const contract = await createContract(t, gateway, {
			clientTlsIdentity: 'tlsId',
...
test('\n\n***** Network End-to-end flow: specify not enough endorsing orgs not using discovery *****\n\n', async (t: any) => {
	const gateway = new Gateway();
	try {
		const contract = await createContract(t, gateway, {
			clientTlsIdentity: 'tlsId',
...
test('\n\n***** Network End-to-end flow: specify correct endorsing orgs not using discovery *****\n\n', async (t: any) => {
	const gateway = new Gateway();
	try {
		const contract = await createContract(t, gateway, {
			clientTlsIdentity: 'tlsId',
